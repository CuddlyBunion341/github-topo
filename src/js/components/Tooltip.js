export default class Tooltip {
  ...
  createTooltipElement() {
    ...
    countIcon.className =
      'tooltip-color-indicator h-4 w-4 rounded-full bg-success-500';
  ...
  show(x, y, data) {
    ...
    if (count === 0) {
      colorEl.className =
        'tooltip-color-indicator h-4 w-4 rounded-full bg-default-200';
    } else if (count <= 3) {
      colorEl.className =
        'tooltip-color-indicator h-4 w-4 rounded-full bg-success-300';
    } else if (count <= 6) {
      colorEl.className =
        'tooltip-color-indicator h-4 w-4 rounded-full bg-success-500';
    } else {
